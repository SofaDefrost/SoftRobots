...
class controller(Sofa.PythonScriptController):
    ...
    def initGraph(self, node):
            ...
            self.cable1Node=self.finger1Node.getChild('effector1')
            self.cable2Node=self.finger2Node.getChild('effector2')
            self.cable3Node=self.finger3Node.getChild('effector3')
