...
..autolink::SoftRobots plugin to model a virtual soft robot driven by actuators.
...
Before continuing this tutorial please try the resulting simulation you need to achieved.

You can load the simulation directly from this documentation by clicking on the following link:
<div>
<pre>
