   ...
   ### Overloaded PythonScriptController callbacks
    ...
    def initGraph(self,controllerNode):
        ...
        if self.inverse:
            ...
            self.rigidNode.createObject('SlidingActuator', name="SlidingActuator2", template="Rigid3", direction=[0 ,0 ,0 ,cos(2*PI/3),0 ,-sin(2*PI/3)], indices='1',
                                        maxPositiveDisp=maxPDisp, maxNegativeDisp=maxNDisp, maxDispVariation='0.05')
            self.rigidNode.createObject('SlidingActuator', name="SlidingActuator3", template="Rigid3", direction=[0 ,0 ,0 ,cos(4*PI/3),0,-sin(4*PI/3) ], indices='2',
                                        maxPositiveDisp=maxPDisp, maxNegativeDisp=maxNDisp, maxDispVariation='0.05')
        else:
