...
def PneumaticCavitySensor(surfaceMeshFileName=None,
                    attachedAsAChildOf=None,
                    attachedTo=None,
                    name="PneumaticCavitySensor",
    ...
    if attachedAsAChildOf == None and attachedTo == None:
        Sofa.msg_error("Your PneumaticCavitySensor isn't link/child of any node, please set the argument attachedTo or attachedAsAChildOf")
        return None
...
def createScene(node):
    ...
    PneumaticCavitySensor(surfaceMeshFileName="mesh/cube.obj", attachedAsAChildOf=node)
